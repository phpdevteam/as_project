<?php
 ...
 include("fckeditor/fckeditor.php");
	...
	if($action == 'get')
	{
		   ...
		   $str = "Select RB._Date,RB._From,RB._To,RB._ID,
  ...
  and from_unixtime(". $end .", '%Y-%m-%d') ";
		...
		if($keywords!="")
		{
			$str .=" And (_StaffRef like '%". $keywords ."%'
	...
	else if($action == 'getDetail')
	{
      ...
      Event Title : <a class="TitleLink" target="_blank" href="appointment.php?id=<?=encrypt($myrow["_ID"],$Encrypt)?>&amp;e_action=<?=encrypt('edit',$Encrypt)?>"><?=$myrow["_Title"]?></a><br/><br/>
