...
$Operations = GetAccessRights(153);
	...
	if($id != "" && $e_action == 'edit')
	{
		$str = "SELECT * FROM ".$tbname."_tax WHERE _id = '".$id."' ";
   ...
   <script type="text/javascript" src="../js/functions.js"></script>
	<script type="text/javascript" language="javascript">
		...
		function validateForm()
		{
			var errormsg;
            errormsg = "";					
            if (document.FormName.taxname.value == 0)
                errormsg += "Please fill in 'Tax Name'.\n";
		...
		function validateForm3()
		{
			...
			else
			{
				if(confirm('Are you sure you want to archive the selected Record(s)?') == true)
				{
					...
					document.forms.FormName2.action = "tax_action.php";
					...
					<tr>
						...
						<tr>
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
								  <td align="left" class="TitleStyle"><b>Settings - System - Tax</b></td>
								</tr>
								<tr><td height=""></td></tr>
							</table>
							<form name="FormName" action="tax_action.php" method="post" onsubmit="return validateForm();" enctype="multipart/form-data">
							...
							<table cellpadding="1" cellspacing="0" border="0" width="100%">
								...
								<tr>
									<td width="120">Tax Name </td>
									<td width="10">&nbsp;:&nbsp;</td>
									<td><input type="text" tabindex="" name="taxname" value="<?=$taxname?>" class="txtbox1" style="width:220" /> <span class="detail_red">*</span></td>
								</tr>
                                <? if ($e_action=="edit") { ?>								
								<tr>
									<td nowrap>&nbsp;Status&nbsp;</td>
							...
							$i = 1;							
							$str1 = "SELECT c._id, c._TaxName, c._subdate,  c._status, u._Fullname as _subby, ss._statusname FROM ".$tbname."_tax c 
							INNER JOIN ".$tbname."_systemstatus ss ON ss._id = c._status  
							INNER JOIN ".$tbname."_user u ON u._ID = c._subby  
							";							
							if ($Keywords != "") $str1 = $str1 . " AND c._TaxName LIKE '%".replaceSpecialChar($Keywords)."%' ";
							if (trim($sortBy) != "" && trim($sortArrange) != "")
								$str2 = $str1 . " ORDER BY ".trim($sortBy)." ".trim($sortArrange)." LIMIT $StartRow,$PageSize ";
							else
								$str2 = $str1 . " ORDER BY c._status , c._TaxName ASC LIMIT $StartRow,$PageSize ";
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									<td colspan="2"><b>Tax List</b></td>
								</tr>
                               	<form name="search_form" action="tax.php" method="get" onsubmit="clearDefault()">
                                <tr> 
                                  <td><input type="text" tabindex="" title="tax" name="Keywords" id="Keywords" value="<?=$Keywords?>" class="defaultText" />&nbsp;&nbsp;<input type="submit" name="btnSearch" class="button1" value="Search" /></td>                                  
                                </tr>
                                </form>
                                <tr>
                                  <td></td>
									...
									<td colspan="2">
										<table cellspacing="0" cellpadding="1" width="100%" border="0" class="grid">
											<tr>
												...
												<td class="gridheader">&nbsp;&nbsp;<a href="?PageNo=<?=$PageNo?>&amp;sortBy=_TaxName&amp;sortArrange=<?=$sortArrange?>" class="link1">Tax Name</a></td>
												 <td class="gridheader" align="center">&nbsp;&nbsp;<a href="?PageNo=<?=$PageNo?>&amp;sortBy=_subby&amp;sortArrange=<?=$sortArrange?>" class="link1">Submitted By</a></td>
                                                <td class="gridheader" align="center">&nbsp;&nbsp;<a href="?PageNo=<?=$PageNo?>&amp;sortBy=_subdate&amp;sortArrange=<?=$sortArrange?>" class="link1">Submitted Date</a></td>
