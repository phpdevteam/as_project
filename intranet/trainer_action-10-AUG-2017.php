...
$emailString = "";
	...
	$cntCheck = $_POST["cntCheck"];
		...
		$str = "UPDATE ".$tbname."_trainerqualification SET _Status = 2 WHERE (" . $emailString . ") ";
...
//add data of relavent education certificate
		...
		$str = "INSERT INTO ".$tbname."_trainerrelevantqualification (_TranerID,_RelevSrNo,_ReleCourseAttend,_ReleQualification,_ReleInstitution,_ReleFrom,_ReleTo,_Filename1) VALUES (";
...
/*$sql = "DELETE FROM ".$tbname."_trainerqualification WHERE _TranerID=$id";
...
$sql1 = "DELETE FROM ".$tbname."_trainerrelevantqualification WHERE _TranerID=$id";
