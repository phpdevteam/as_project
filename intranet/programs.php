	...
	<script type="text/javascript" language="javascript">
		...
		function validateForm3()
		{
			...
			else
			{
				...
				{
					document.forms.FormName.action = "program_action.php";
		...
		function export2CSV()
	{
		document.forms.FormName.action ="exportexcel.php?name=programlist";
	    document.forms.FormName.submit();	
	}
		//-->
	</script>
					...
					<tr>
						...
						<tr>							
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
								  <td align="left" class="TitleStyle"><b>Settings > Programs</b></td>
								</tr>
							</table>
                               		...
                               		<?php
                                            ...
                                            $programno		= trim($_GET["programno"]);	
                                            $programName	= trim($_GET["programName"]);	
                                            $procategory 	= trim($_GET["procategory"]);
                                            ...
                                            $str1 = "SELECT tp.*,t._FullName,pcat._ProgramCatName,tt._TypeName  FROM ".$tbname."_trainingprogram AS tp  LEFT JOIN  as_trainingprogramcat pcat ON tp._ProgramCatID = pcat._ID 
											LEFT JOIN  ".$tbname."_trainers AS t  ON tp._TrainerID = t._ID
											LEFT JOIN  ".$tbname."_trainingtype AS tt  ON tp._TrainingTypeID = tt._ID   WHERE tp._ID > 0";
                                            
                                            if($Keywords != "Enter Any Keywords" && $Keywords != "")
                                            {
												$str1 = $str1 . " AND (tp._ProgramName LIKE '%".replaceSpecialChar($Keywords)."%' ";
                                                
                                                $str1 = $str1 . " OR tp._ProgramRefID LIKE '%".replaceSpecialChar($Keywords)."%' ";
												
                                               
                                            
                                                $str1 = $str1 . " OR tp._TotalAmount LIKE '%".replaceSpecialChar($Keywords)."%' ";
												
												$str1 = $str1 . " OR t._FullName LIKE '%".replaceSpecialChar($Keywords)."%' ";
												
												$str1 = $str1 . " OR tt._TypeName LIKE '%".replaceSpecialChar($Keywords)."%' ";
												
                                                $str1 = $str1 . " OR pcat._ProgramCatName LIKE '%".replaceSpecialChar($Keywords)."%' ) ";
                                            }
                                            
                                            else if($programName != "Enter Program Name" && $programName != "")
                                            {
												
                                                $str1 = $str1 . " AND (tp._ProgramName LIKE '%".replaceSpecialChar($programName)."%' )";
                                            }
                                            else if($procategory != "Enter Category" && $procategory != "")
                                            {
												
                                                $str1 = $str1 . " AND (pcat._ProgramCatName LIKE '%".replaceSpecialChar($procategory)."%' )";
                                            }
                                            
                                            else
                                            {
												
												 if ($programno != "" && $programno2 != "") $str1 = $str1 . " AND tp._ProgramRefID between '".replaceSpecialChar($programno)."'  and '".replaceSpecialChar($programno2)."'";
												
                                                 else if ($programno != "") $str1 = $str1 . " AND tp._ProgramRefID LIKE '%".replaceSpecialChar($programno)."%' ";
                                 		...
                                 		<div id="QuickSearch">
                                            <form name="QuickSearch" action="programs.php" method="get" onsubmit="clearDefault()">
                                             ...
                                             <input type="hidden" name="type" value="<?=$type?>" />
                                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
												...
												<tr>
													<td align="left" colspan="6"><b>Quick Search/List Programs</b></td>   
                                                    ...
                                                    <tr>
														...
														<td width="5"></td>
														<td class="defaultTextlbl"><input name="programno" type="text" tabindex="" title="Search Program Ref"  class="defaultText" id="programno" value="<?=$programno?>" maxlength="255" /></td>
														<td width="5"></td>
														<td class="defaultTextlbl"><input name="programName" type="text" tabindex="" title="Enter Program Name" class="defaultText" id="programName" value="<?=$programName?>" maxlength="255" /></td>
														<td width="5"></td>
														<td colspan="3"></td>
                                                    </tr>
													<tr><td height="5"></td> </tr>
													<tr>
														<td class="defaultTextlbl"><input name="procategory" type="text" tabindex="" title="Enter Category " class="defaultText" id="procategory" value="<?=$procategory?>" maxlength="255"/></td>
														<td width="5"></td>
                                  ...
                                  <!--   Training Type: 
										...
										{
										?>  
											<a href="programs.php?status=" class="TitleLink" id="SearchByAdv">All</a>
										<?php
										}
										else
										{
										?>
											...
											<a href="programs.php?status="  class="currentfilter" >All</a>
										...
										{
										?>  
											<a href="programs.php?status=1" class="TitleLink">Personal Training</a>
										<?php
										}
										else
										{
										?>
											<a href="programs.php?status=1"  class="currentfilter">Personal Training</a>
										<?php
										}
										?>
										|
										...
										{
										?>  
											<a href="programs.php?status=2" class="TitleLink">Group Training</a>
										<?php
										}
										else
										{
										?>
											<a href="programs.php?status=2"  class="currentfilter">Group Training</a>
										<?php
										}
										?>-->
										...
										{
										?>  
											<a href="programs.php?status=" class="TitleLink" >All</a>
										<?php
										}
										else
										{
										...
										{
										?>  
											<a href="programs.php?status=1" class="TitleLink">Live</a>
										<?php
										}
										else
										{
										?>
											<a href="programs.php?status=1"  class="currentfilter">Live</a>
										<?php
										}
										?>
										|
										...
										{
										?>  
											<a href="programs.php?status=2" class="TitleLink">Archive</a>
										<?php
										}
										else
										{
										?>
											<a href="programs.php?status=2"  class="currentfilter">Archive</a>
										<?php
										}
										?>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <table cellspacing="0" cellpadding="3" width="100%" border="0" class="grid" >
                                                    <tr>
                                                        ...
                                                        <td class="gridheader" width="100" align="center"><a href="?PageNo=<?=$PageNo?>&amp;sortBy=_ProgramRefID<?=$ExtraUrl?>" class="link1">Program Ref No.</a></td>
                                                        <td class="gridheader" width="100" align="center">
                                                            &nbsp;<a href="?PageNo=<?=$PageNo?>&amp;sortBy=_ProgramName<?=$ExtraUrl?>" class="link1">Program Name</a>
                                                        </td>
                                                       
                                                        <td class="gridheader" width="100" align="center">
                                                            &nbsp;<a href="?PageNo=<?=$PageNo?>&amp;sortBy=_ProgramCatName<?=$ExtraUrl?>" class="link1">Category Name</a>
														</td>
														<td class="gridheader" width="130" align="center">
                                                            &nbsp;<a href="?PageNo=<?=$PageNo?>&amp;sortBy=_TypeName<?=$ExtraUrl?>" class="link1">Program Type</a>
														</td>
                                                      ...
                                                      <!--  <td class="gridheader datecolumn"  width="120"  align="center">
															<a href="?PageNo=<?=$PageNo?>&amp;sortBy=_subdate<?=$ExtraUrl?>" class="link1">
                                                            &nbsp;Applicable date range</a>-->
                                                        </td>
                                                    ...
                                                    while($rs = mysql_fetch_assoc($result))
                                                    {
                                                        ...
                                                        ?>
                                                        <tr class="clickableRow" href="program.php?PageNo=<?=encrypt($PageNo,$Encrypt)?>&amp;id=<?=encrypt($rs["_ID"],$Encrypt)?>&amp;e_action=<?=encrypt("edit",$Encrypt)?>" style="cursor:pointer" >
                                                            ...
                                                            <td id="Row3ID<?=$i?>" class="<?php echo $Rowcolor; ?>" align="center">&nbsp;<?php echo $rs['_ProgramRefID']; ?>&nbsp;</td>
                                                            <td id="Row4ID<?=$i?>" class="<?php echo $Rowcolor; ?>" width="100"><?=replaceSpecialCharBack($rs["_ProgramName"])?></td>
                                                            <td id="Row5ID<?=$i?>" class="<?php echo $Rowcolor; ?>" align="left" ><?=replaceSpecialCharBack($rs["_ProgramCatName"])?></td>
                                                            <td id="Row8ID<?=$i?>" class="<?php echo $Rowcolor; ?>" align="center" ><?=replaceSpecialCharBack($rs["_TypeName"])?></td>
                                                            <td id="Row9ID<?=$i?>" class="<?php echo $Rowcolor; ?>" align="center" ><?=replaceSpecialCharBack($rs["_TotalAmount"])?></td>
                                                            <!--<td id="Row10ID<?=$i?>" class="<?php echo $Rowcolor; ?>" align="center" ><?=replaceSpecialCharBack($rs["_StartTime"].'  - '. $rs["_EndTime"] )?></td>-->
                                                            <td id="Row11ID<?=$i?>" class="<?php echo $Rowcolor; ?>" align="center" ><?= ($rs['_Status'] == '1' ? 'Live' : 'Archive')?></td> 
															...
															if(in_array("Edit",$Operations))
															{
																...
																<a href="program.php?PageNo=<?=encrypt($PageNo,$Encrypt)?>&amp;id=<?=encrypt($rs["_ID"],$Encrypt)?>&amp;e_action=<?=encrypt("edit",$Encrypt)?>" class="TitleLink">Edit</a>
