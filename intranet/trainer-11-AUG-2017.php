                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
								 ...
								 <tr>
                                    ...
                                    <table id="demo123" border="1" cellspacing="0"  class="grid" style="text-align:center;width:895px;" >
                                            <tr>
                                                <th  width="5%"class="gridheader"><input class='check_all' type='checkbox'  onclick="select_all()"/></th>
                                    ...
                                    
                                    {
                                        ...
                                        $str1= "SELECT * FROM ".$tbname."_trainerqualification WHERE _TranerID =$id";
                                        $rst = mysql_query("set names 'utf8';");
$i=1;
                                    ...
                                    <br/>
                                            ...
                                            <button type="button" id='delete' class="button1"    style="text-align:center;width:70px;"><b> Delete</b></button>
