<?php
	...
	if($id != "" && $e_action == 'edit' && $ctab == '0')
	{
        ...
        $str1 = "SELECT  v.*,p._ProgramName,p._ProgramCatID,p._TrainingTypeID,tg._ID FROM ".$tbname."_venueavailableslot v  LEFT JOIN  ".$tbname."_trainingprogram p ON v._ProgramID = p._ID 
        LEFT JOIN  ".$tbname."_trainingprogramaggregation tg ON v._ID = tg._VenueSchduleID 
         where  v._ID = '".$id."' ";	
		...
		if(mysql_num_rows($rst) > 0)
		{
            ...
            $venueID                 = replaceSpecialCharBack($rs["_VenueID"]);
			$venueschedulardate      = mysqlToDatepicker($rs["_Date"]);
			$venueschedulartimefrom  = replaceSpecialCharBack($rs["_StartTime"]);
            $venueschedulartimeto    = replaceSpecialCharBack($rs["_EndTime"]);
	...
	<script type="text/javascript" language="javascript">
     ...
     $(document).ready(function () {
        ...
        function validateForm4()
		{
				...
				document.forms.FormName0.action = "venueschedule_action.php?action12=delete1";
        ...
        success: function(response)
           {
            ...
            $("#maxvenuefeesurcharge").html(response);
                        ...
                        <tr>
                            <td>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                          <td align="left" class="TitleStyle"><b>Add/Edit Venue Schedules</b></td>
                                        </tr>
                                        <tr><td height=""></td></tr>
                                    </table>
                                   <br/>
                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                    ...
                                    <td align="left"><b>
                                      <?
                                                if($id != "" || $e_action == 'edit')
                                                {
                                                    echo "Edit Venue Schedules";
                                                }
                                                else
                                                {
                                                    echo "Add Venue Schedules";
                                                }
											  ?>                                              
								  </td>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                  ...
                                  <tr><td>
                                    ...
                                    <tr>
                                    <td>
                                        <form name="FormName0" action="venueschedule_action.php"  method="post" onsubmit="return validateForm0();" enctype="multipart/form-data">
                                 ...
                                 <tr>
                                            ...
                                            <td height="10"></td>
                                                ...
                                                <? $str = "SELECT _ID,_ProgramName FROM ".$tbname."_trainingprogram ORDER BY _ID";
                                                    $rst = mysql_query($str, $connect) or die(mysql_error());?>
                                                <select  tabindex="" name="programID" id="programID" class="dropdown1  chosen-select" onchange="change_venuecharges()";>
                                                    <option value="">-- Select One --</option>
                                                    <?php
                                      ...
                                      <td height="10"></td>
                                           ...
                                           <tr>
                                            ...
                                            <td valign="middle" width="10px">&nbsp;:&nbsp;</td>
                                            <td valign="middle"><input type="text" tabindex="" id="schedulardate" name="schedulardate" value="<?=$venueschedulardate == ""?date('d/m/Y'):$venueschedulardate?>" size="60" class="txtbox1 datepicker" style="width:164px;">   <b> (DD/MM/YYYY)</b></td>
                                            </tr>
                                            <tr>
                                      <td height="5"></td>
                                      <td height="5"></td>
                                      <td height="10"></td>
                                            ...
                                            <td valign="middle" width="10px">&nbsp;:&nbsp;</td>
                                            <td valign="middle"><input type="text" tabindex="" id="schedulartimefrom" name="schedulartimefrom" value="<?php echo $venueschedulartimefrom;?>" size="60" class="txtbox1"  style="width:80px;"> To 
                                            <input type="text" tabindex="" id="schedulartimeto" name="schedulartimeto" value="<?php echo $venueschedulartimeto;?>" size="60" class="txtbox1"  style="width:80px;"></td>
                                            ...
                                            <td valign="middle">    <div id="maxvenuefeesurcharge" name ="maxvenuefeesurcharge"  size="60" class="txtbox1"  readonly="readonly"   style="width:120px;padding: 1px;"><?php echo $maxvenuefeesurcharge;?> </div> </td>
                                            </tr>
                                    ...
                                    
                                    {
                                        ...
                                        $str1= "SELECT * FROM ".$tbname."_trainingprogramsurcharge WHERE _ProgramaggregationID = '$aggreID' AND _AddedBy ='VO' AND  _Status=1";
                                        ...
                                        $i=1;
                                            ...
                                            ?>
                                                ...
                                                <td  class="gridline2"><input type='text' id='itemamount' name='itemamount[]'   value="<?php echo $itemamount;?>" onkeypress="return isNumber(event)" style="width:120px"/></td>
                                            ...
                                            ?>
                                             ...
                                             <tr>
                                               <td class="gridline2"><input type='checkbox' class='case'  name="AllCheckbox1" id="AllCheckbox1"value="All" onclick="CheckUnChecked('FormName0','CustCheckboxq',document.FormName0.cntCheck1.value,this,'<?=$colCount?>');"  /></td>
                                                ...
                                                <td class="gridline2"><input type='text' id='itemamount' name='itemamount[]' onkeypress="return isNumber(event)" style="width:120px"/></td>
...
<tr>
                                                ...
                                                <td>OR &nbsp;&nbsp;&nbsp;&nbsp;<input type="file" name="attFile1[]" size="40" class="txtbox1" style="width:180px;"></td>
...
$("#addmore").on('click',function(){
    ...
    data +="<td class='gridline2'><select name='surchageitem[]' style='width:180px;'><option>-- Select One --</option><option value='1'>Trainer Fee</option><option value='2'>Shower Charge</option><option value='3'>Premium Gym Charge</option><option value='4'>Loaded MVT Charge</option></select></td> <td class='gridline2'><input type='text' id='itemamount"+k+"' name='itemamount[]' onkeypress='return isNumber(event)' style='width:120px'/></td></tr>";
	$('#demo123').append(data);
	k++;
});
</script>
