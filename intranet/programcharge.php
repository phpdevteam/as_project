     ...
     function validateForm3()
		{
				...
				document.forms.FormName0.action = "programcharge_action.php?action12=delete1";
                            ...
                            <td>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                  ...
                                  <tr><td>
                                    ...
                                    <tr>
                                    <td>
                                        <form name="FormName0" action="programcharge_action.php"  method="post" onsubmit="return validateForm0();" enctype="multipart/form-data">
                                      ...
                                      <td height="5"></td>
                                              ...
                                              <tr>
                                                    <td  valign="middle">Programs Sub Sub Type </td>
                                                        <td  valign="middle">&nbsp;:&nbsp;</td>
                                                        <td valign="middle" >
                                                            <select  tabindex="10" name="programsubsubtypeID" id="programsubsubtypeID" class="dropdown1 chosen-select"  style="width:250px;">
                                                            <option value="">--select--</option>
                                                            <?php
