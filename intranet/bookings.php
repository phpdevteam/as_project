	...
	<script type="text/javascript" language="javascript">
		...
		function validateForm3()
		{
			...
			else
			{
				...
				{
					document.forms.FormName.action = "booking_action.php";
					...
					<tr>
						...
						<tr>							
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
								  <td align="left" class="TitleStyle"><b>Bookings</b></td>
								</tr>
							</table>
                               		...
                               		<?php
                                            ...
                                            $str1 = "SELECT tp.*,t._FullName,v._VenueName,tt._TypeName,ag._StartTime,ag._EndTime,ag._TotalAmount FROM ".$tbname."_trainingprogram AS tp  INNER JOIN  as_trainingprogramaggregation ag ON tp._ID = ag._ProgramID 
                                            ...
                                            else if($programno != "Search Program Ref" && $programno != "")
                                            {
												
                                                $str1 = $str1 . " AND (tp._ProgramRefID	 LIKE '%".replaceSpecialChar($programno)."%' )";
											}
                                            ...
                                            else if($programtype != "Search Program Type" && $programtype != "")
                                            {
												
                                                $str1 = $str1 . " AND (tt._TypeName LIKE '%".replaceSpecialChar($programtype)."%' )";
											}
                                 		...
                                 		<div id="QuickSearch">
                                            <form name="QuickSearch" action="bookings.php" method="get" onsubmit="clearDefault()">
                                             ...
                                             <input type="hidden" name="type" value="<?=$type?>" />
                                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
												...
												<tr>
													<td align="left" colspan="6"><b>Quick Search/List Bookings</b></td>   
														...
														if(in_array("Add",$Operations))
														{
															?>
																...
																<a href="booking.php" class="TitleLink">Add New</a>
                                  ...
                                  <!--   Training Type: 
										...
										{
										?>  
											<a href="bookings.php?status=" class="TitleLink" >All</a>
										<?php
										}
										else
										{
										?>
											<a href="bookings.php?status="  class="currentfilter" >All</a>
										<?php
										}
										?>
										| 
										...
										{
										?>  
											<a href="bookings.php?status=1" class="TitleLink">Live</a>
										<?php
										}
										else
										{
										?>
											<a href="bookings.php?status=1"  class="currentfilter">Live</a>
										<?php
										}
										?>
										|
										...
										{
										?>  
											<a href="bookings.php?status=2" class="TitleLink">Archive</a>
										<?php
										}
										else
										{
										?>
											<a href="bookings.php?status=2"  class="currentfilter">Archive</a>
										<?php
										}
										?>
                                                ...
                                                <table cellspacing="0" cellpadding="3" width="100%" border="0" class="grid" >
                                                    <tr>
														...
														<td class="gridheader" width="130" align="center">
                                                            &nbsp;<a href="?PageNo=<?=$PageNo?>&amp;sortBy=_VenueName<?=$ExtraUrl?>" class="link1">Venue Name</a>
														</td>
													  
                                                        <td class="gridheader datecolumn"  width="50" align="center">
															<a href="?PageNo=<?=$PageNo?>&amp;sortBy=_TypeName<?=$ExtraUrl?>" class="link1">
                                                            &nbsp;Type</a>
                                                        </td>
                                                  ...
                                                  <td class="gridheader datecolumn"  width="120"  align="center">
                                                    ...
                                                    while($rs = mysql_fetch_assoc($result))
                                                    {
                                                        ...
                                                        ?>
                                                        <tr class="clickableRow" href="booking.php?PageNo=<?=encrypt($PageNo,$Encrypt)?>&amp;id=<?=encrypt($rs["_ID"],$Encrypt)?>&amp;e_action=<?=encrypt("edit",$Encrypt)?>" style="cursor:pointer" >
                                                            ...
                                                            <td id="Row5ID<?=$i?>" class="<?php echo $Rowcolor; ?>" align="left" ><?=replaceSpecialCharBack($rs["_FullName"])?></td>
                                                            <td id="Row8ID<?=$i?>" class="<?php echo $Rowcolor; ?>" align="center" ><?=replaceSpecialCharBack($rs["_VenueName"])?></td>
                                                            <td id="Row9ID<?=$i?>" class="<?php echo $Rowcolor; ?>" align="center" ><?=replaceSpecialCharBack($rs["_TypeName"])?></td>
                                                            <td id="Row10ID<?=$i?>" class="<?php echo $Rowcolor; ?>" align="center" ><?= $createdate = date("d/m/Y", strtotime($rs["_CreatedDateTime"]))?></td> 
															...
															if(in_array("Edit",$Operations))
															{
																...
																<a href="booking.php?PageNo=<?=encrypt($PageNo,$Encrypt)?>&amp;id=<?=encrypt($rs["_ID"],$Encrypt)?>&amp;e_action=<?=encrypt("edit",$Encrypt)?>" class="TitleLink">View</a>
