					...
					<tr>
						...
						<tr>							
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
								  <td align="left" class="TitleStyle"><b>Schedules</b></td>
								</tr>
							</table>
                               		...
                               		<?php
                                         ...
                                         /*   $Keywords 		= trim($_GET["Keywords"]);
                                            ...
                                            $str1 = "SELECT *  FROM ".$tbname."_customer AS cust WHERE cust._id > 0 ";
                                            
                                            if($Keywords != "Enter Any Keywords" && $Keywords != "")
                                            {
												$str1 = $str1 . " AND (cust._clientname LIKE '%".replaceSpecialChar($Keywords)."%' ";
                                            ...
                                            else if($clientName != "Enter Client Name" && $clientName != "")
                                            {
                                                ...
                                                $str1 = $str1 . " AND (cust._clientname LIKE '%".replaceSpecialChar($clientName)."%' )";
											}
                                            else
                                            {
                                                ...
                                                if ($companyname1 != "") $str1 = $str1 . " AND cust._clientname LIKE '%".replaceSpecialChar($companyname1)."%' ";
                                             ...
                                             <input type="hidden" name="type" value="<?=$type?>" />
                                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
												...
												<tr>
                                                    ...
                                                    <tr>
														<td width="85">Search Date : </td><td width="220px"><input name="searchdate" type="text" tabindex="" title="Enter Search Date" class="defaultText" id="searchdate" value="<?=$searchdate?>" maxlength="255"/></td>
												
														<td width="85">Schedule Type : </td><td width="220px"> <input name="scheduletype" type="text" tabindex="" title="Select Schedule Type" class="defaultText" id="scheduletype" value="<?=$scheduletype?>" maxlength="255"/></td>
														<td width="85">Location : </td><td><input name="location" type="text" tabindex="" title="Enter  Location" class="defaultText" id="location" value="<?=$location?>" maxlength="255"/></td>
													
													</tr>
													<tr><td height="5"></td></tr>
													<tr>
													<td width="85">Trainer : </td><td width="105"><input name="trainer" type="text" tabindex="" title="Enter Trainer" class="defaultText" id="trainer" value="<?=$trainer?>" maxlength="255"/></td>
														<td width="115">Training Schedules booked : </td><td><input name="traschedbooked" type="text" tabindex="" title="Enter Training Schedules booked" class="defaultText" id="traschedbooked" value="<?=$traschedbooked?>" maxlength="255"/></td>
													</tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <table cellspacing="0" cellpadding="3" width="100%" border="0" class="grid" >
												 ...
												 <td  style="padding-right:2px;text-align:right;">
														<a href="booking.php" class="TitleLink" style="margin-right: 212px;">Add Booking</a>
