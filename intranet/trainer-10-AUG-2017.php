...
function validateForm0()
  ...
  <tr>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
								 ...
								 <tr>
                                    ...
                                    <table id="demo123" border="1" cellspacing="0"  class="grid" style="text-align:center;width:895px;" >
                                            <tr>
                                                <th  width="5%"class="gridheader"><input name="AllCheckbox" id="AllCheckbox" type="checkbox"   tabindex="" value="All" onclick="CheckUnChecked('FormName','CustCheckbox',document.FormName.cntCheck.value,this,'<?=$colCount?>');" /></th>
                                    ...
                                    
                                    {
                                        ...
                                        $i=1;
                                            ...
                                            ?>
                                                ...
                                                <td class="gridline2"><input type='text' id='srno' name='srno[]' value="<?php echo $srno;?>" style="width:10px;border:0px;"></td>
                                                ...
                                                <td  class="gridline2"><input type='text' id='from' name='from[]'  onkeypress="return isNumber(event)" maxlength="4" value="<?php echo $from;?>" style="width:70px"/></td>
 ...
 <input type="hidden" name="cntCheck" value="<?php echo $i-1; ?>" />        
                                        <?php } else{?>
                                    <tr>
                                    <td class="gridline2"><input type='checkbox' class='case'  name="AllCheckbox1" id="AllCheckbox1"value="All" onclick="CheckUnChecked('FormName0','CustCheckbox',document.FormName0.cntCheck1.value,this,'<?=$colCount?>');"  /></td>
                                                <td class="gridline2" width="16px;"><input type='text' id='srno' name='srno[]'  style="width:10px;border:0px;">1.</td>
                           ...
                           <table id="test123" border="1" cellspacing="0"  style="text-align:center;width:900px;" >
                                <tr>
                                    <th class="gridheader"  width="20px"><input class='check_all1' type='checkbox' onclick="select_all()"/></th>
                                    <th class="gridheader" width="40px" style="font-size:12px;">S / No</th>
                                    <th class="gridheader" width="150px" style="font-size:12px;">Course Attended  <br/>(e.g. Yoga Instructor Course) </th>                
                                    
                                    <th class="gridheader"  width="140px" style="font-size:12px;">Qualifications Obtained <br/>(e.g. Yoga Instructor Certificate) </th>
                                    
                                    <th class="gridheader"  width="140px" style="font-size:12px;">Name of Institution / <br/>Examination Board</th>
                            ...
                            if($e_action == 'edit')                           
                            {
                                    ...
                                    $str1= "SELECT * FROM ".$tbname."_trainerrelevantqualification WHERE _TranerID =$id";
                                    ...
                                    ?>
                                <td class="gridline2"><input type='checkbox' class='case'/></td>
                                <td class="gridline2" width="10px;"><input type='text' id='relSrno' name='relSrno[]' value="<?php echo $relSrno;?>" style="width:10px;border:0px;"></td>
                                <td class="gridline2"><input type='text' id='courseatten' name='courseatten[]' value="<?php echo $courseatten;?>" style="width:200px"/></td>
                                <!--<td><input type='text' id='relqualiobtain' name='relqualiobtain[]'   value="<?php echo $relqualiobtain;?>" style="width:200px"/></td>-->
                                <td class="gridline2" > <a href="<?php echo $AdminTopCMSImagesPath;?><?php echo $picpod;?>" target="_blank" style="color:#FF0000; font-family:arial; font-size:11px;"><?php echo $filename1;?></a>&nbsp;</td>
                                <td class="gridline2"><input type='text' id='relinstitution' name='relinstitution[]'   value="<?php echo $relinstitution;?>" style="width:200px"/></td>
                                <td class="gridline2"><input type='text' id='relfrom' name='relfrom[]'  onkeypress="return isNumber(event)" maxlength="4" value="<?php echo $relfrom;?>" style="width:70px"/></td>
                                <td class="gridline2"><input type='text' id='relto' name='relto[]' onkeypress="return isNumber(event)" maxlength="4" value="<?php echo $relto;?>"  style="width:70px"/> </td>
                                </tr>	
                             <?php
                                }
                                 }
                    ...
                    <tr>
                    <td class="gridline2"><input type='checkbox' class='case'/></td>
                                <td class="gridline2" width="10px;"><input type='text' id='relSrno' name='relSrno[]'  style="width:15px;border:0px;">1.</td>
                                <td><input type='text' id='courseatten' name='courseatten[]' style="width:200px"/></td>
                                ...
                                <td class="gridline2"><input type='text' id='relinstitution' name='relinstitution[]' style="width:200px"/></td>
                                <td class="gridline2"><input type='text' id='relfrom' name='relfrom[]' onkeypress="return isNumber(event)" maxlength="4"  style="width:70px"/></td>
                                <td class="gridline2"><input type='text' id='relto' name='relto[]' onkeypress="return isNumber(event)" maxlength="4" style="width:70px"/> </td>
                     ...
                     <?php } ?>
                            ...
                            <tr>
                            <td>
                            <button type="button" id="delete1" class="button1"   style="text-align:center;width:70px;"><b>  Delete</b></button>
                            </td>
                            </tr>
                             </td></tr>  
									<tr>
...
$("#addmore").on('click',function(){
    var data="<tr><td class='gridline2'><input type='checkbox' class='case'/></td><td class='gridline2'> <input type='text' id='srno' name='srno[]' value="+k+" style='width:10px;border:0px;'>"+".</td>";
...
$("#addmore1").on('click',function(){
    var data="<tr><td class='gridline2'><input type='checkbox' class='case'/></td><td class='gridline2'> <input type='text' id='relSrno' name='relSrno[]' value="+j+" style='width:10px;border:0px;'>"+".</td>";
    data +="<td class='gridline2'><input type='text' id='courseatten"+j+"' name='courseatten[]'   style='width:180px'/></td><td class='gridline2'> <input type='file' id='attFile"+j+"' name='attFile[]' size='40' class='txtbox1'></td> <td class='gridline2'><input type='text' id='relinstitution"+j+"' name='relinstitution[]' style='width:180px'/></td><td class='gridline2'><input type='text' id='relfrom"+j+"' name='relfrom[]' onkeypress='return isNumber(event)' maxlength='4' style='width:70px'/></td><td class='gridline2'><input type='text' id='relto"+j+"' name='relto[]' onkeypress='return isNumber(event)' maxlength='4' style='width:70px'/></td></tr>";
	$('#test123').append(data);
	j++;
});
</script>
