...
$fields = array();
$attfile = array();
$str = "Show columns From ".$tbname."_trainerrelevantqualification  Where Field <> '_ID' ";
...
for($i=0;$i<count($attFiles["name"]);$i++)
{
	...
	if($FileName != "")
	{
		...
		$str = "INSERT INTO ".$tbname."_trainerrelevantqualification(".implode(',', $fields).") VALUES (".implode(',', $values).")";
