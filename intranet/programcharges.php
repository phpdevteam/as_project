	...
	<script type="text/javascript" language="javascript">
		...
		function validateForm3()
		{
			...
			else
			{
				...
				{
					document.forms.FormName.action = "programcharge_action.php";
								  ...
								  <td align="left" class="TitleStyle"><b>Program Charges</b></td>
                               		...
                               		<?php
											...
											if (trim($sortArrange) == "DESC")
                                                ...
                                                $programsubtype	= trim($_GET["programsubtype"]);	
                                                $programsubsubtype 	= trim($_GET["programsubsubtype"]);
                                            ...
                                            $str1 = "SELECT tc.*,tt._TypeName,ts._SubTypeName,tsp._SubSubTypeName  FROM ".$tbname."_trainingcharges AS tc LEFT JOIN  ".$tbname."_trainingtype tt ON tc._TrainingTypeID = tt._ID 
											LEFT JOIN  ".$tbname."_trainingsubtype AS ts  ON tc._TrainingSubTypeID = ts._ID
											LEFT JOIN  ".$tbname."_trainingsubsubtype AS tsp  ON tc._TrainingSubSubTypeID = tsp._ID   WHERE tc._ID > 0";
                                            
                                            if($Keywords != "Enter Any Keywords" && $Keywords != "")
                                            {
												$str1 = $str1 . " AND (tt._TypeName LIKE '%".replaceSpecialChar($Keywords)."%' ";
                                                
                                                $str1 = $str1 . " OR ts._SubTypeName LIKE '%".replaceSpecialChar($Keywords)."%' ";
												
                                                $str1 = $str1 . " OR tsp._SubSubTypeName LIKE '%".replaceSpecialChar($Keywords)."%' ) ";
                                            }
                                            
                                            else if($programtype != "Search Programs Type" && $programtype != "")
                                            {
												
                                                $str1 = $str1 . " AND (tt._TypeName LIKE '%".replaceSpecialChar($programtype)."%')";
                                            }
                                            else if($programsubtype != "Search Programs Sub Type" && $programsubtype != "")
                                            {
												
                                                $str1 = $str1 . " AND (ts._SubTypeName LIKE '%".replaceSpecialChar($programsubtype)."%')";
                                            }
                                 		...
                                 		<div id="QuickSearch">
                                            <form name="QuickSearch" action="programcharges.php" method="get" onsubmit="clearDefault()">
                                              ...
                                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
												...
												<tr>
													<td align="left" colspan="6"><b>Quick Search/List Clients</b></td>   
														...
														if(in_array("Add",$Operations))
														{
															?>
																...
																<a href="programcharge.php?type=<?=$_REQUEST['type']?>" class="TitleLink">Add New</a>
                                                    ...
                                                    <tr>
														...
														<td width="5"></td>
														<td class="defaultTextlbl"><input name="programtype" type="text" tabindex="" title="Search Programs Type"  class="defaultText" id="programtype" value="<?=$programtype?>" maxlength="255" /></td>
														<td width="5"></td>
														<td class="defaultTextlbl"><input name="programsubtype" type="text" tabindex="" title="Search Programs Sub Type" class="defaultText" id="programsubtype" value="<?=$programsubtype?>" maxlength="255" /></td>
														<td width="5"></td>
														<td colspan="3"></td>
                                                    </tr>
                                    ...
                                    <tr><td align="left"  colspan="2">
                                      ...
                                      <!--  Training Type: 
										...
										{
										?>  
											<a href="programcharges.php?status=" class="TitleLink" >All</a>
										<?php
										}
										else
										{
										?>
											<a href="programcharges.php?status="  class="currentfilter" >All</a>
										<?php
										}
										?>
										| 
										...
										{
										?>  
											<a href="programcharges.php?status=1" class="TitleLink">Live</a>
										<?php
										}
										else
										{
										?>
											<a href="programcharges.php?status=1"  class="currentfilter">Live</a>
										<?php
										}
										?>
										|
										...
										{
										?>  
											<a href="programcharges.php?status=2" class="TitleLink">Archive</a>
										<?php
										}
										else
										{
										?>
											<a href="programcharges.php?status=2"  class="currentfilter">Archive</a>
										<?php
										}
										?>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <table cellspacing="0" cellpadding="3" width="100%" border="0" class="grid" >
                                                    <tr>
                                                        ...
                                                        <td class="gridheader" width="190" align="center"><a href="?PageNo=<?=$PageNo?>&amp;sortBy=_TypeName<?=$ExtraUrl?>" class="link1">Programs Type </a></td>
                                                        <td class="gridheader" width="200" align="center">
                                                            &nbsp;<a href="?PageNo=<?=$PageNo?>&amp;sortBy=_SubTypeName<?=$ExtraUrl?>" class="link1">Programs Sub Type </a>
                                                        </td>
                                                       
                                                        <td class="gridheader" width="200"  align="center">
                                                            &nbsp;<a href="?PageNo=<?=$PageNo?>&amp;sortBy=_SubSubTypeName<?=$ExtraUrl?>" class="link1">Programs Sub Sub Type </a>
														</td>
                                                    ...
                                                    while($rs = mysql_fetch_assoc($result))
                                                    {
                                                        ...
                                                        ?>
                                                        <tr class="clickableRow" href="programcharge.php?PageNo=<?=encrypt($PageNo,$Encrypt)?>&amp;id=<?=encrypt($rs["_ID"],$Encrypt)?>&amp;e_action=<?=encrypt("edit",$Encrypt)?>" style="cursor:pointer" >
                                                            ...
                                                            <td id="Row3ID<?=$i?>" class="<?php echo $Rowcolor; ?>" align="center">&nbsp;<?php echo $rs['_TypeName']; ?>&nbsp;</td>
                                                            <td id="Row4ID<?=$i?>" class="<?php echo $Rowcolor; ?>" width="100"><?=replaceSpecialCharBack($rs["_SubTypeName"])?></td>
                                                            <td id="Row5ID<?=$i?>" class="<?php echo $Rowcolor; ?>" width="100"><?=replaceSpecialCharBack($rs["_SubSubTypeName"])?></td>
															...
															if(in_array("Edit",$Operations))
															{
																...
																<a href="programcharge.php?PageNo=<?=encrypt($PageNo,$Encrypt)?>&amp;id=<?=encrypt($rs["_ID"],$Encrypt)?>&amp;e_action=<?=encrypt("edit",$Encrypt)?>" class="TitleLink">Edit</a>
