...
if($e_action == 'addnew')
	{
		$str = "INSERT INTO ".$tbname."_trainers 
				...
				_MpDeclaration1,_MpDeclaration2,_MpDeclaration3,_MpDeclaration4,_AnswerOfYes,_FooterSignature,_FooterDate,_MembershipStatus,_ReasonForSuspensionDelist,_CreatedBy,_CreatedDateTime,_UpdatedDateTime,_UpdatedBy)
				VALUES(";
